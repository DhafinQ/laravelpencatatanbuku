...
<div class="row">
    <div class="d-flex flex-row-reverse mb-2">
        <a href="/buku/create" class="btn btn-secondary"><i class="bi bi-plus"></i>Tambah Buku</a>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        <table class="table table-hover" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$buku->penerbit}}</td>
                    <td>
                    <a href="/buku/{{$buku->id}}" class="btn btn-sm btn-primary"><i class="bi bi-box-arrow-up-right"></i> Detail</a>
                    </td>
                    <td class="d-flex">
