...
<div class="col-8 offset-2">
    <h2>Edit Buku</h2>
        <form action="/buku/{{$buku->id}}" enctype="multipart/form-data" method="POST">
            ...
            <div class="row mb-3">
                <label for="ukuran" class="col-md-4 col-form-label ">Ukuran</label>
                    <div class="input-group">
                        <input type="number" name="ukuran" id="ukuran" class="form-control" aria-describedby="centi" value="{{ $buku->ukuran }}">
                        <span class="input-group-text" id="centi">cm</span>
                    </div>
            ...
            <div class="row mb-3">
                <label for="cover" class="col-md-4 col-form-label ">Cover Buku</label>
